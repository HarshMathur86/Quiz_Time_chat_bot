# Quiz Time chat bot
 ...
 - The bot is implemented using ***python*** programming language and ***postgres SQL*** database.
 - Following APIs are used in the implementation of the bot:
...
# New architecture(Version 2.0.1)
 - Following is the new Architecture Diagram draft of new version. Horizontally scalable design.
